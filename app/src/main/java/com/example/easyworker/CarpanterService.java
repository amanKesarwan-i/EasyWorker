...
public class CarpanterService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carpanter_service);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(CarpanterService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(CarpanterService.this,MainActivity.class);
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CarpanterService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(CarpanterService.this,Help.class);
                if (help.resolveActivity(getPackageManager())!=null)
                {
                    startActivity(help);
                }
        ...
        service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CarpanterService.this, "Service", Toast.LENGTH_SHORT).show();
                Intent service = new Intent(CarpanterService.this, Service.class);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(CarpanterService.this, "Share", Toast.LENGTH_SHORT).show();
                Intent share = new Intent(CarpanterService.this,Share.class);
        ...
        account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(CarpanterService.this, "Account", Toast.LENGTH_SHORT).show();
                Intent account = new Intent(CarpanterService.this,Account.class);
        ...
        db.collection("cart")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(CarpanterService.this,"Service booked successfully..",Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(CarpanterService.this,"Some error occured..",Toast.LENGTH_SHORT).show();
