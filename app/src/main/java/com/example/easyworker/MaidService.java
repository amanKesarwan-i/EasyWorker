    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MaidService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(MaidService.this,MainActivity.class);
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MaidService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(MaidService.this,Help.class);
                if (help.resolveActivity(getPackageManager())!=null)
                {
                    startActivity(help);
                }
        ...
        service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MaidService.this, "Service", Toast.LENGTH_SHORT).show();
                Intent service = new Intent(MaidService.this, Service.class);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MaidService.this, "Share", Toast.LENGTH_SHORT).show();
                Intent share = new Intent(MaidService.this,Share.class);
        ...
        account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MaidService.this, "Account", Toast.LENGTH_SHORT).show();
                Intent account = new Intent(MaidService.this,Account.class);
        ...
        db.collection("cart")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(MaidService.this,"Service booked successfully..",Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MaidService.this,"Some error occured..",Toast.LENGTH_SHORT).show();
