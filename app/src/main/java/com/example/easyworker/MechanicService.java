...
public class MechanicService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MechanicService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(MechanicService.this,MainActivity.class);
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MechanicService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(MechanicService.this,Help.class);
                if (help.resolveActivity(getPackageManager())!=null)
                {
                    startActivity(help);
                }
        ...
        service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MechanicService.this, "Service", Toast.LENGTH_SHORT).show();
                Intent service = new Intent(MechanicService.this, Service.class);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MechanicService.this, "Share", Toast.LENGTH_SHORT).show();
                Intent share = new Intent(MechanicService.this,Share.class);
        ...
        account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MechanicService.this, "Account", Toast.LENGTH_SHORT).show();
                Intent account = new Intent(MechanicService.this,Account.class);
        ...
        db.collection("cart")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(MechanicService.this,"Service booked successfully..",Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MechanicService.this,"Some error occured..",Toast.LENGTH_SHORT).show();
