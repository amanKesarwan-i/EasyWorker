...
public class PlumberService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(PlumberService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(PlumberService.this,MainActivity.class);
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PlumberService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(PlumberService.this,Help.class);
                if (help.resolveActivity(getPackageManager())!=null)
                {
                    startActivity(help);
                }
        ...
        service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PlumberService.this, "Service", Toast.LENGTH_SHORT).show();
                Intent service = new Intent(PlumberService.this, Service.class);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(PlumberService.this, "Share", Toast.LENGTH_SHORT).show();
                Intent share = new Intent(PlumberService.this,Share.class);
        ...
        account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(PlumberService.this, "Account", Toast.LENGTH_SHORT).show();
                Intent account = new Intent(PlumberService.this,Account.class);
        ...
        db.collection("cart")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(PlumberService.this,"Service booked successfully..",Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(PlumberService.this,"Some error occured..",Toast.LENGTH_SHORT).show();
