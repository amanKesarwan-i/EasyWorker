...
public class EletricianService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eletrician_service);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(EletricianService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(EletricianService.this,MainActivity.class);
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(EletricianService.this, "Help", Toast.LENGTH_SHORT).show();
                Intent help = new Intent(EletricianService.this,Help.class);
                if (help.resolveActivity(getPackageManager())!=null)
                {
                    startActivity(help);
                }
        ...
        service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(EletricianService.this, "Service", Toast.LENGTH_SHORT).show();
                Intent service = new Intent(EletricianService.this, Service.class);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(EletricianService.this, "Share", Toast.LENGTH_SHORT).show();
                Intent share = new Intent(EletricianService.this,Share.class);
        ...
        account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(EletricianService.this, "Account", Toast.LENGTH_SHORT).show();
                Intent account = new Intent(EletricianService.this,Account.class);
        ...
        db.collection("cart")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(EletricianService.this,"Service booked successfully..",Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EletricianService.this,"Some error occured..",Toast.LENGTH_SHORT).show();
